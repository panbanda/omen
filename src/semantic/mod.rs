...
//! vector embeddings generated by the all-MiniLM-L6-v2 ONNX model.
//!
//! # Architecture
//!
//! - **model**: Downloads and manages the ONNX model and tokenizer
//! - **embed**: Generates vector embeddings from code text
...
//!
//! ```no_run
//! use omen::semantic::{SemanticSearch, SearchConfig};
//!
