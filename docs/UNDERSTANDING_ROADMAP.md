...
| Coding-agent outcomes | Registered paired-outcome scorer with fail-closed checks | `omen eval`: 19 unit tests and 3 CLI tests | Configured model runner, authorized budget, independent held-out tasks and logs |
