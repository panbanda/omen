...
; Detects Flipper.enabled?(), Flipper.enable(), Flipper.disable(), Flipper.feature(), etc.
...
((call
  ...
  (#eq? @receiver "Flipper")
  (#match? @method "^(enabled\\?|enable|disable|feature|enable_actor|disable_actor|enable_group|disable_group|enable_percentage_of_actors|enable_percentage_of_time)$"))
