...
func TestTemporalCouplingAnalyzer_WithMockOpener(t *testing.T) {
	...
	analyzer := NewTemporalCouplingAnalyzer(30, 3, WithTemporalOpener(mockOpener))
...
func TestWithTemporalOpener(t *testing.T) {
	mockOpener := mocks.NewMockOpener(t)
	analyzer := NewTemporalCouplingAnalyzer(30, 3, WithTemporalOpener(mockOpener))
...
func TestTemporalCouplingAnalyzer_DefaultValues(t *testing.T) {
	analyzer := NewTemporalCouplingAnalyzer(0, 0)
	if analyzer.days != 30 {
