...
; Detects is_feature_enabled() and get_feature_flag() calls
...
(#match? @method "^(is_feature_enabled|get_feature_flag|get_feature_flag_payload)$")
...
(#match? @method "^(is_feature_enabled|get_feature_flag)$")
